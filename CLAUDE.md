...
1. **Check expected behavior first** — Visit https://www.wysiwyg-editor.dev/ to see how it should work
...
5. **Implementation question?** Check `reference/wysiwyg-editor` (read → close → write fresh!)
